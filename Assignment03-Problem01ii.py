...
# Assignment 3
# Problem 1 part i
""" Using the random forest algorithm, this program will split the Iris data set into :
...
if __name__ == '__main__':
    ...
    plt.ylabel('Accuracy')
    plt.title('Accuracy of Random Forests Trained on Different Data Splits')
